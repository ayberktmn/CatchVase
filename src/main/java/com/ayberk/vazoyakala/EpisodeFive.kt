...
class EpisodeFive : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_episode_five)
        ...
        object  : CountDownTimer(15300,1000){
            override fun onTick(p0: Long) {
                timeText7.text="Time:" + p0/1000
            }

            override fun onFinish() {
                timeText7.text="Time: 0"
                ...
                val alert = AlertDialog.Builder(this@EpisodeFive)
                ...
                alert.setPositiveButton("Yes") {dialog,which ->
                    ...
                    Toast.makeText(this@EpisodeFive, "Tekrar deneyelim", Toast.LENGTH_SHORT).show()
                ...
                alert.setNegativeButton("No"){dialog,which ->
                    ...
                    startActivity(intent)
                    Toast.makeText(this@EpisodeFive, "Tebrikler", Toast.LENGTH_SHORT).show()
                }
                alert.show()
            }
