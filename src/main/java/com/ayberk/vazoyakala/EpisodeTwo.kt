...
class EpisodeTwo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_episode_two)
        val intent = intent
        ...
        object  : CountDownTimer(17300,1000){
            override fun onTick(p0: Long) {
                timeText3.text="Time:" + p0/1000
            }

            override fun onFinish() {
                timeText3.text="Time: 0"
                ...
                val alert = AlertDialog.Builder(this@EpisodeTwo)
                ...
                alert.setPositiveButton("Yes") {dialog,which ->
                    ...
                    Toast.makeText(this@EpisodeTwo, "Tekrar deneyelim", Toast.LENGTH_SHORT).show()
                }
                if(score<20)
                ...
                alert.setNegativeButton("No"){dialog,which ->
                    ...
                    startActivity(intent)
                    Toast.makeText(this@EpisodeTwo, "Tebrikler", Toast.LENGTH_SHORT).show()
                }
                alert.show()
            }
