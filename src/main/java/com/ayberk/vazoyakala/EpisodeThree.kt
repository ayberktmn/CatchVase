...
import kotlinx.android.synthetic.main.activity_episode_three.*
import kotlinx.android.synthetic.main.activity_episode_two.*
import java.util.*
import kotlin.collections.ArrayList

class EpisodeThree : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_episode_three)
        ...
        object  : CountDownTimer(17300,1000){
            override fun onTick(p0: Long) {
                timeText4.text="Time:" + p0/1000
            }

            override fun onFinish() {
                timeText4.text="Time: 0"
                ...
                val alert = AlertDialog.Builder(this@EpisodeThree)
                ...
                alert.setPositiveButton("Yes") {dialog,which ->
                    ...
                    Toast.makeText(this@EpisodeThree, "Tekrar deneyelim", Toast.LENGTH_SHORT).show()
                    finish()
                }
                alert.show()
                if(score<25)
                ...
                alert.setNegativeButton("No"){dialog,which ->
                    ...
                    startActivity(intent)
                    Toast.makeText(this@EpisodeThree, "Tebrikler", Toast.LENGTH_SHORT).show()
                }
                alert.show()
            }
