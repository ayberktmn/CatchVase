...
class EpisodeOne : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_episode_one)
        ...
        object  : CountDownTimer(20300,1000){
            override fun onTick(p0: Long) {
                timeText2.text="Time:" + p0/1000
    }

            override fun onFinish() {
                timeText2.text="Time: 0"
                ...
                val alert = AlertDialog.Builder(this@EpisodeOne)
                ...
                alert.setPositiveButton("Yes") {dialog,which ->
                    ...
                    Toast.makeText(this@EpisodeOne, "Tekrar deneyelim", Toast.LENGTH_SHORT).show()
                ...
                alert.setNegativeButton("No"){dialog,which ->
                    ...
                    startActivity(intent)
                    Toast.makeText(this@EpisodeOne, "Tebrikler", Toast.LENGTH_SHORT).show()
                }
                alert.show()
            }
